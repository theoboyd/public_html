...
var strings_es = {
  "slide":"p&aacute;g.",
  "":"Ayuda",
  "contents":"&Iacute;ndice",
  "table of contents":"tabla de contenidos",
  "Table of Contents":"Tabla de Contenidos",
  "restart presentation":"Reiniciar presentaci$oacute;n",
  "restart":"Inicio"
   };

strings_es[helpText] =
    "Utilice el rat&oacute;n, barra espaciadora, teclas Izda/Dcha, " +
    "o Re p&aacute;g y Av p&aacute;g. Use S y B para cambiar el tama&ntilde;o de fuente.";
...
var strings_pl = {
  ...
  "Table of Contents":"Spis Tresci",
  "restart presentation":"Restartuj prezentacje",
  "restart":"restart"
   };

strings_pl[helpText] =
    "Zmieniaj slajdy klikajac mysza, naciskajac spacje, strzalki lewo/prawo" +
    "lub PgUp / PgDn. Uzyj klawiszy S i B, aby zmienic rozmiar czczionki.";
...
strings_hu[helpText] =
    ...
    "Page Up billentyuket. Az S és a B billentyukkel változtathatja " +
    "a szöveg méretét.";
...
var strings_el = {
  ...
  "":"ß???e?a;",
  "contents":"pe??e??µe?a;",
  "table of contents":"p??a?a? pe??e??µ????",
  "Table of Contents":"???a?a? ?e??e??µ????",
  "restart presentation":"epa?e?????s? pa???s?as??",
  "restart":"epa?e?????s?;"
   };

strings_el[helpText] =
  "???????e?te µe t? ???? t?? p??t?????, t? space, ta ß??? a??ste??/de???, " +
  "? Page Up ?a? Page Down. ???s?µ?p???ste ta p???t?a S ?a? B ??a ?a a????ete " +
  "t? µ??e??? t?? ??aµµat?se????.";
