                  ...
                  <ol>
                     ...
                     <li>There is no personal winner of the social prize; the donation to charity will be managed by the Organiser and attributed proportionally to people whose strategies contributed socially.</li>
                  ...
                  <ol>
                     ...
                     <li>Submissions for the "Prize-eligible Tournament" will close on <?php echo $end_date ?> at 23:59 GMT.</li>
                     ...
                     <li>While you will always remain the author of your submission, for the purposes of research and the mechanics of the study, you hereby assign and grant to the Organiser in perpetuity certain rights to the submission, including, but not limited to, the royalty-free right to display, store, modify and copy the submission, particularly on this website and in the project report, without compensation. You will be credited if any of your intellectual property is used.
                     ...
                     <li>The competition organiser ("Organiser") is Theodore Boyd who is in the University's Department of Computing and can be contacted via the details on <a href="index.php" class="legallink">his homepage.</a></li>
                  </ol>
