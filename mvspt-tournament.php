            <h3>The Tournament</h3>
               ...
               <p>The structure will follow this timeline (allowing for more tournaments if there is time):</p>
               <ol>
               ...
               <p>For a more in-depth description of the study that we will be performing, download the project interim report:</p>
